<div id="profile">
	<div class="content">
		...
		<ul>
			...
			<li><img class="photo" src="assets/images/companies/facebook.png"><img class="logo" style="display:none;" src="assets/images/companies/facebook1.png" ><div class="fit" style="display:none;">85</div></li>
			<li><img class="photo" src="assets/images/companies/google.png" ><img class="logo" style="display:none;" src="assets/images/companies/google1.png" ><div class="fit" style="display:none;">82</div></li>
			<li><img class="photo" src="assets/images/companies/goldman-sachs.png" ><img class="logo" style="display:none;" src="assets/images/companies/goldman-sachs1.png" ><div class="fit" style="display:none;">84</div></li>
			<li><img class="photo" src="assets/images/companies/ge.png" ><img class="logo" style="display:none;" src="assets/images/companies/ge1.png" ><div class="fit" style="display:none;">81</div></li>
		</ul>
	</div>
</div>
