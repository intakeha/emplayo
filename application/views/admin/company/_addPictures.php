...
<div id="admin">
	<div class="content">
		...
		<div id="pictures">
			<div id="company_name">Company: <a href="/company/profile/<?php echo $company_id;?>"><?php echo $company_info['company_name'];?></a></div><br>
			
			<p> Click browse to upload a picture:</p>
		...
		$(document).ready(function(){
			...
			$('#fileupload').fileupload({
				...
				if (data.result.success == 1){
				    ...
				    $('.logo_pic').attr('src','<?php echo base_url().PROFILE_PIC_TEMP_PATH;?>'+data.result.message);
				    $('#logo_preview img').attr('src','<?php echo base_url().PROFILE_PIC_TEMP_PATH;?>'+data.result.message);
