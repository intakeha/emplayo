...
<div id="container">
    <div id="logo">
      ...
      <!--  <input id="fileupload" type="file" name="userfile" data-url="/admin/company/logo_upload" multiple>-->
...
<form id="fileupload" action="/admin/company/logo_upload" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" name="last_temp_file" value=""/>
        ...
        <div id="next_one">
        <p> ...or click 'Next' to move to the next image. </p>  
        <input class="buttons crop_buttons" id="next_image" type="button" name="next_image" value="Next"/>         
        </div>
