...
$lang['valid_email']		= "Please provide a valid email address";
$lang['valid_emails']		= "Please provide valid email addresses";
$lang['valid_url']			= "%s must be a valid URL";
$lang['valid_ip']			= "%s must be a valid IP";
...
$lang['matches']			= "%ss do not match";
$lang['is_unique'] 		= "%s must be a unique value";
$lang['is_natural']			= "%s must be only positive numbers";
$lang['is_natural_no_zero']	= "%s must be a number greater than zero";
$lang['decimal']			= "%s must be a decimal number";
$lang['less_than']			= "%s must be a number less than %s";
$lang['greater_than']		= "%s must be a number greater than %s";
